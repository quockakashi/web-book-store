...
const renderIndexPage = async (req, res, next) => {
    try {
        ...
        res.render('products/index', {
            layout: 'layouts/index', title: 'Product Management', component: { name: 'Products', subtitle: 'Product Management', }, products, categories, meta: {
    ...
    try {
        ...
        if(id) {
            ...
            if(product) {
                ...
                return res.render('products/edit-product', {layout: 'layouts/index', title: 'Edit Product', component: {name: 'Products', subtitle: `Edit product #${id}`}, product, categories});
            }
        }
